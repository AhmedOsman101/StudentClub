<div class="get-task h-100">
    <div class="card rounded-3">
            ...
            <thead>
                <tr>
                    <div class="d-flex align-items-center">
                        ...
                        <div style="width: 40px;"><img style="max-width: 100%;" src="images/check.png" alt=""></div>
                    </div>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <div class="d-flex align-content-center ">
                            @if($todo->status)
                            <input wire:click="toggle({{$todo->id}})" class="mr-2 form-check-input" type="checkbox"
                                checked>
                            <input type="text" placeholder="{{ $todo->task }}" value="{{ $todo->task }}" class="mx-1"
                                wire:model="EditTask.{{ $todo->id }}" wire:keydown.enter="save({{ $todo->id }})"
                    ...
                    <td>
                        <div class="d-flex align-items-center justify-content-center">
                            <svg wire:click="delete({{$todo->id}})" class="delete inline-block"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                <path fill="#ed1d1d"
                                    d="M170.5 51.6L151.5 80h145l-19-28.4c-1.5-2.2-4-3.6-6.7-3.6H177.1c-2.7 0-5.2 1.3-6.7 3.6zm147-26.6L354.2 80H368h48 8c13.3 0 24 10.7 24 24s-10.7 24-24 24h-8V432c0 44.2-35.8 80-80
        ...
        <div class="empty-todo">
            ...
            <div class="notask">
                <img src="images/no-task.png" alt="">
            </div>
        </div>
        @endif
